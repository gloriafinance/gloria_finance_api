export enum SupplierType {
  SUPPLIER = "SUPPLIER", // Proveedor de bienes
  TECHNOLOGY_PROVIDER = "TECHNOLOGY_PROVIDER", // Proveedores tecnológicos
  FINANCIAL_PROVIDER = "FINANCIAL_PROVIDER", // Proveedores financieros
